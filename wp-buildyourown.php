<?php
/**
 * Plugin Name: Build Starter Packages
...
<?php
	function packgageb()
	{
		...
		$url=str_replace('wp-content/plugins/package','',dirname(__FILE__));
      ...
      <div class="contentpr1">
        ...
        <div class="faces" id="faceShow"> <!--face-->
            <div class="facesHeading">
				<div class="faceHead">Choose a Watch Face</div>
			</div>
...
<?php
 ...
 add_shortcode('build_your_package', 'packgageb');



 function packgageminib()
	{
		global $wbdb;
		global $wpdb;
		$pluginDirectory = trailingslashit(plugins_url(basename(dirname(__FILE__))));
			...
			<div class="facesHeading">
              ...
              <div class="facescontent">				
                  <?php
					...
					<select name="pack_band1" id="pack_band1" class="price_band1">
						<option data-price-band1="0" value="0"> Select Band </div>
					  <?php 
						$i=0;
                        foreach ( $obj_options->posts as $obj_option ) :
...
<?php
 ...
 add_shortcode('build_your_package_mini', 'packgageminib');
